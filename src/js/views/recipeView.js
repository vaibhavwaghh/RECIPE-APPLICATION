...
class RecipeView extends View {
  ...
  /**HANDLING LOAD AND CLICK EVENT */
  addHandlerRender(handler) {
    /**I WANT TO CALL controlRecipes METHOD FOR MULTIPLE EVENTS */
    /**METHOD 1 */
    // window.addEventListener('click', controlRecipes);  window.addEventListener('load', controlRecipes);
